...
export default function Home() {
  ...
  return (
    ...
    <main className="min-h-screen w-full bg-[#6f7378] text-[#e4edf2] overflow-x-hidden overflow-y-auto">

      {/* MAIN CONTAINER */}

      <div className="relative min-h-screen w-full overflow-hidden border border-[#8796a3] m-0 lg:m-4 bg-[#787d82] shadow-[0_0_50px_rgba(0,0,0,0.28)]">
        ...
        <header className="min-h-[80px] border-b border-[#93a1ad] flex flex-col lg:flex-row lg:items-center justify-center lg:justify-between px-4 sm:px-6 lg:px-10 py-4 gap-4 bg-[#6f7479]/90 backdrop-blur-sm">
...
>
          ...
          <aside className="border-b lg:border-b-0 lg:border-r border-[#93a1ad] p-4 sm:p-6 lg:p-8 flex flex-col bg-[#6f7f8a]/75 overflow-hidden">
            ...
            <div className="relative border border-[#74828b] bg-[#5f6d7828] h-[680px] lg:h-[620px] overflow-hidden flex items-center justify-center shadow-inner">
              ...
              <div className="absolute inset-0 bg-[radial-gradient(circle,rgba(91, 245, 194, 0.62)_0%,transparent_70%)]" />
...
<section className="relative overflow-visible flex flex-col bg-[#72777c] min-h-[125vh] sm:min-h-[130vh] lg:min-h-0 w-full">
  ...
  <div className="flex justify-center items-start pt-28 sm:pt-36 lg:pt-16 relative">
  ...
  <div className="relative z-30 mt-[-30px] sm:mt-[-60px] lg:mt-auto">
    ...
    <div className="border-t border-[#6f7e87] bg-[#6e7378]/80 backdrop-blur-md px-4 sm:px-8 py-5">
...
<div className="group flex justify-center items-start pt-28 sm:pt-36 lg:pt-16 relative">
  ...
  <div className="h-[72vh] sm:h-[82vh] lg:h-[108vh]" />
...
<aside className="border-t lg:border-t-0 lg:border-l border-[#66757f] p-4 sm:p-6 lg:p-8 overflow-hidden bg-[#74797e]/70">
           {/* SUBJECT PROFILE */}
